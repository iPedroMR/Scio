            ...
            <section id="perfil-form">
                <div class="container">
                    <form id="perfil-form">
                        ...
                        <input type="text" id="fname" name="firstname" placeholder="Seu nome..." value="Pedro">

                        <label for="lname">Sobrenome</label>
                        <input type="text" id="lname" name="lastname" placeholder="Seu sobrenome..." value="Rezende">

                        <label for="lemail">Email</label>
                        <input type="email" id="lemail" name="email" placeholder="E-mail..." value="ipedromr@hotmail.com">

                        
                    </form>
                    
                  <div class="mb-4">
                            <button class="btn btn-primary" onclick="esqueci()">Esqueci minha senha</button>
                        </div>
                  
                  <button onclick="perfil()" class="btn btn-primary">Salvar</button>
